...
| `useReducer`  | Manage data with complex state                        | No                          |
| `useContext`  | share data globally across your entire component tree | No                          |
...
## 2. `useEffect` (Lifecycle & Synchronization)
...
## 6 & 7 . `useReducer` + `useContext` (State Management)
